...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <?php elseif(auth()->user() == "dosen"): ?>
        <?php echo $__env->make('dosen.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      <?php elseif(auth()->user() == "karyawan"): ?>
        <?php echo $__env->make('karyawan.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      <?php else: ?>
        <?php echo $__env->make('mahasiswa.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      <?php endif; ?>
